...
def _state_get(self):
    return [()]
    self.env.cr.execute("SELECT code, name from location_master_state_master")
...
class res_partner(osv.Model, format_address):
    ...
    _columns = {
        ...
        #'user_state': fields.selection(_state_get, 'State', help="State of the user like Gujarat, Punjab, etc."),
