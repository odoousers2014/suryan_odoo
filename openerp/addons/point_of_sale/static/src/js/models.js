function openerp_pos_models(instance, module){ //module is instance.point_of_sale
    ...
    module.PosModel = Backbone.Model.extend({
        ...
        models: [
        {
            ...
            model:  'res.company',
            fields: [ 'currency_id', 'email', 'website', 'company_registry', 'vat', 'name', 'phone', 'partner_id' , 'country_id','street','street2','city'],
    ...
    module.Orderline = Backbone.Model.extend({
        ...
        get_all_prices: function(){
            ...
            /*Mapped data and amount*/
            var total = 0;
            _.map(taxes, function(tax) {
                    total+=tax.amount;
                });
            /*Mapped data and amount*/
            _.each(taxes, function(tax) {
                if (tax.price_include) {
                    ...
                    if (tax.type === "percent") {
                        ...
                        tmp =  (base / (1 + total)) * tax.amount; // Commented above line and replaced by this line so to meet client requirements.
